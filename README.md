# mihomoYBTraeAI 智能分流配置脚本 - 使用说明

## 📖 简介

`mihomoYBTraeAI.js` 是一个专为 mihomo（Clash 变种）设计的**智能分流配置脚本**。它能够自动管理您的代理节点，根据网络质量、地理位置和访问需求，智能选择最佳节点，让您的网络访问更加流畅、稳定。
...
1. **将脚本添加到 mihomo 配置**
   - 在您的 mihomo 配置文件中，将 `mihomoYBTraeAI.js` 作为脚本引用
   - 脚本会自动处理您的代理配置
